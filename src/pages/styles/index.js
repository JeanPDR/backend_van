...
export const Button = styled.TouchableOpacity`
  ...
  background: ${(props) =>
    props.color ? theme.colors[props.color] : "#4267B2"};
`;

export const ButtonText = styled.Text`
  text-align: center;
  color: ${(props) => (props.color ? theme.colors[props.color] : "#fff")};
`;
...
export const PickerButton = (styled.Button = styled.TouchableOpacity`
  width: 100%;
  height: 40%;
  margin-top: 2.5%;
  border-width: 3px;
